...
class _$AuthResponseTearOff {
  ...
  _AuthResponse call({String? message, User? user, String? token}) {
...
class _$_AuthResponse implements _AuthResponse {
  _$_AuthResponse({this.message, this.user, this.token});
...
abstract class _AuthResponse implements AuthResponse {
  factory _AuthResponse({String? message, User? user, String? token}) =
      _$_AuthResponse;
